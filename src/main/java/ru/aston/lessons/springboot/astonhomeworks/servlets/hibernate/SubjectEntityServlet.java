...
import ru.aston.lessons.springboot.astonhomeworks.service.impl.hibernate.SubjectServiceEntityImpl;
...
@WebServlet(urlPatterns = {"/hibernate/subjects/*"})
public class SubjectEntityServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        SubjectService subjectService = new SubjectServiceEntityImpl();
