...
import ru.aston.lessons.springboot.astonhomeworks.service.impl.hibernate.TeacherServiceEntityImpl;
...
@WebServlet(urlPatterns = {"/hibernate/teachers/*"})
public class TeacherEntityServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        TeacherService teacherService = new TeacherServiceEntityImpl();
